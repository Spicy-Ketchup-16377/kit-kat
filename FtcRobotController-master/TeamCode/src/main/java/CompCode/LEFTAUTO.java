 ...
 */
@Autonomous(name = "LEFT_AUTOO", group = "COMP")
public class LEFTAUTO extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //turn
        double turnAngle2 = Math.toRadians(125); //135
        ...
        Trajectory HIGH_HEADING = drive.trajectoryBuilder(BACKCONES.end())
                .lineToLinearHeading(new Pose2d(-36,-12,Math.toRadians(52)))
                .build();

        Trajectory HIGH2 = drive.trajectoryBuilder(HIGH_HEADING.end())
                .lineTo(new Vector2d(-23.5,-4.5))
                .build();
        //wait (arm stuff happens) place preload
        ...
        //turn
        double turnAngle3 = Math.toRadians(132);
